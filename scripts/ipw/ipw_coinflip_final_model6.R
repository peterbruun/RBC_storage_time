...
p.denom <- glm(exposure_binary==1 ~ 
                    ...
                    rcspline.eval(bt_difference,knots=c(0,10,20,30,40)) +
                    rcspline.eval(total_transfusions,knots=c(0,10,20,30,40)) +
                    rcspline.eval(n_transfusions,knots=c(0,10,20,30,40)) +
                    #rcspline.eval(lag1_n_transfusions,knots=c(0,10,20,30,40)) +
...
p.num <- glm(exposure_binary==1 ~ rcspline.eval(total_transfusions,knots=c(0,10,20,30,40)), data=data_trans, family = "binomial")
...
p.denom <- glm(acute_package==0 ~ 
                    ...
                    #rcspline.eval(total_nonexposure,knots=c(0,1,2,4,9)) +
                    rcspline.eval(total_transfusions,knots=c(0,10,20,30,40)) +
...
p.num <- glm(acute_package==0 ~ time + I(time^2) + 
                    rcspline.eval(total_ratio_diff,knots=c(-1,-0.5,0,0.5,1)) +
                    rcspline.eval(total_transfusions,knots=c(0,10,20,30,40)), data=data_bootstrap, family = "binomial")
...
ipw.model <- glm(event==0 ~ rcspline.eval(total_ratio_diff,knots=c(-1,-0.5,0,0.5,1)) * time + 
                            rcspline.eval(total_transfusions_all,knots=c(0,10,20,30,40)) * time +
                            rcspline.eval(total_ratio_diff,knots=c(-1,-0.5,0,0.5,1)) *  I(time^2) +
                            rcspline.eval(total_transfusions_all,knots=c(0,10,20,30,40)) * I(time^2),
